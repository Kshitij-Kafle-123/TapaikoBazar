...
<section class="jumbotron text-center">
	<h1 class="jumbotron-heading">ELECTRONICS</h1>
	<a href="ProductController?actions=electronic">Show Electronics</a>
			...
			<div class="col">
				<div class="row">
					<div class="col-12 col-md-6 col-lg-4">
						<div class="card">
							<img class="card-img-top" src="images/ele.jpg"
								alt="Card image cap">
							<div class="card-body">
								<h4 class="card-title">
									<a href="#" title="View Product"><c:out
											value="${p.productName }"></c:out></a>
								</h4>
								<p class="card-text">
								...
								<div class="row">
									...
									<div class="col">
										<a
											href="ProductController?actions=shop&id=${p.id}&pname=${p.productName}"
